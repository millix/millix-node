    ...
    getTransactionExtended(transactionID) {
        return new Promise((resolve, reject) => {
            this.database.all(
                ...
                'TIN.input_position, TIN.output_transaction_id, TIN.output_shard_id, TIN.output_position, TIN.output_transaction_date, TIN.double_spend_date AS input_double_spend_date, TIN.is_double_spend AS input_is_double_spend, TIN.address AS input_address, TIN.address_key_identifier as input_address_key_identifier, TIN.status AS input_status, TIN.create_date AS input_create_date, ' +
