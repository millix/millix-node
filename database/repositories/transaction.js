        ...
        return new Promise((resolve, reject) => {
            const {
                      ...
                      parameters
                                          ...
                                          'TPP.transaction_id_parent, TPP.transaction_id_child, TPP.shard_id AS shard_id_child, TPPT.shard_id AS shard_id_parent, TPP.status AS transaction_parent_status, TPP.create_date AS transaction_parent_create_date ' +
                                          ...
                                          'LEFT JOIN `transaction` AS TPPT ON TPPT.transaction_id = TPP.transaction_id_parent', where);
