...
export const WALLET_TRANSACTION_DEFAULT_VERSION        = MODE_TEST_NETWORK ? 'la0l' : null;
export const WALLET_TRANSACTION_REFRESH_VERSION        = MODE_TEST_NETWORK ? 'lb0l' : null;
...
export const NODE_MILLIX_VERSION                       = '1.6.0';
