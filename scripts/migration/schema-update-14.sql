...
UPDATE config SET config_name='transaction_fee_proxy', config_id='qTCYsDQzIoVbaX8iIjry', value='100' WHERE config_name='transaction_fee_proxy';
...
UPDATE config SET config_name='transaction_fee_default', config_id='eoSDGGFKD3dYfcKF1nFO', value='100' WHERE config_name='transaction_fee_default';
